...
class conv1(nn.Module):
    def __init__(self):
        ...
        # self.fn1 = nn.Linear(64, 1)
        self.fn1 = nn.Linear(64, 256)
        self.fn2 = nn.Linear(256, 128)
        self.fn3 = nn.Linear(128, 1)
...
class diagnosis_model(nn.Module):
    def __init__(self):
        super(diagnosis_model, self).__init__()
        self.relu = nn.ReLU()
        self.softmax = nn.Softmax(dim=1)
